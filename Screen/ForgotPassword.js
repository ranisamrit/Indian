  ...
  return (
    ...
    <SafeAreaView style={style.container}>
      <ScrollView>
        ...
        <View style={{ justifyContent: "center", flexDirection: "row", marginTop: 30 }}>
        <Text style={{ fontSize: 18, paddingTop: 10, marginBottom: 10,marginRight:290 }}>OTP</Text>
        </View>
        ...
        <Text style={{ fontSize: 18, paddingTop: 10, marginBottom: 10,marginRight:260 }}>Password</Text>
        </View>
        <View style={style.SectionStyle}>
          <TextInput
            style={style.inputStyle}
        ...
        <View style={{ justifyContent: "center", flexDirection: "row", }}>
        <Text style={{ fontSize: 18, paddingTop: 10, marginBottom: 10,marginRight:190 }}>Confirm Password</Text>
        </View>
        <View style={style.SectionStyle}>
          <TextInput
            style={style.inputStyle}
